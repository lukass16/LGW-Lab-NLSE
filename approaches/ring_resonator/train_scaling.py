...
Usage:
    ...
    python -m approaches.ring_resonator.train_scaling --num_modes 4 --N_train 50  # CLI only
    python -m approaches.ring_resonator.train_scaling --config approaches/ring_resonator/configs/config_ring_scaling_trace_large.yaml --lr 1e-4  # config + CLI override
"""
