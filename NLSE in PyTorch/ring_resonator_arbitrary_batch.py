...
Usage:
    python ring_resonator_arbitrary_batch.py --config configs/config_ring_arbitrary_fidelity.yaml
    python ring_resonator_arbitrary_batch.py --num_modes 4 --N_train 50  # CLI only
    python ring_resonator_arbitrary_batch.py --config configs/config_ring_arbitrary_trace.yaml --lr 1e-4  # config + CLI override
"""
