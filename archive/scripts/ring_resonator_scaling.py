...
==========================================
Standalone script for inverse design of strong pulse amplitudes in a ring
resonator via XPM. Optimizes per-loop scaling factors (alphas) applied to
the strong soliton pulse to shape the weak pulse output.

Usage:
    python ring_resonator_scaling.py                          # defaults
    python ring_resonator_scaling.py --N_train 50 --lr 5e-4   # custom
    python ring_resonator_scaling.py --output_dir results/     # save plots
"""
...
def parse_args():
    p = argparse.ArgumentParser(
        description="Ring Resonator Scaled-Amplitude Training",
